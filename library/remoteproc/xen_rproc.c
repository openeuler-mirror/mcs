...
static int set_resource(struct remoteproc *rproc, char *key, char *value)
{
	...
	} else if (match_cmd(key, "MaxMemory")) {
	...
	syslog(LOG_INFO, "set_resource ret %d", ret);
